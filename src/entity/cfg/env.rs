...
pub const BAIBOT_USER_TRON_PRIVATE_KEY: &str = "BAIBOT_USER_TRON_PRIVATE_KEY";
pub const BAIBOT_USER_TRON_SEED_PHRASE: &str = "BAIBOT_USER_TRON_SEED_PHRASE";
pub const BAIBOT_USER_TRON_ORIGIN: &str = "BAIBOT_USER_TRON_ORIGIN";
...
/// Prefix of one variable per locale: `BAIBOT_ROOM_POST_JOIN_SELF_INTRODUCTION_TEXT_EN`,
/// `..._TEXT_RU`, … set (or, when empty, unset) the text of that locale.
pub const BAIBOT_ROOM_POST_JOIN_SELF_INTRODUCTION_TEXT_PREFIX: &str =
    "BAIBOT_ROOM_POST_JOIN_SELF_INTRODUCTION_TEXT_";

pub const BAIBOT_I18N_FALLBACK_LOCALE: &str = "BAIBOT_I18N_FALLBACK_LOCALE";

pub const BAIBOT_LOGGING: &str = "BAIBOT_LOGGING";

pub const BAIBOT_ACCESS_ADMIN_PATTERNS: &str = "BAIBOT_ACCESS_ADMIN_PATTERNS";
pub const BAIBOT_ACCESS_COMMANDS_ADMIN_ONLY: &str = "BAIBOT_ACCESS_COMMANDS_ADMIN_ONLY";
pub const BAIBOT_ACCESS_COMMANDS_ADMIN_EXEMPT: &str = "BAIBOT_ACCESS_COMMANDS_ADMIN_EXEMPT";
...
pub const BAIBOT_BILLING_RESERVE_AMOUNT_USD: &str = "BAIBOT_BILLING_RESERVE_AMOUNT_USD";
pub const BAIBOT_BILLING_MARKUP_PCT: &str = "BAIBOT_BILLING_MARKUP_PCT";
pub const BAIBOT_BILLING_DAILY_CAP_USD: &str = "BAIBOT_BILLING_DAILY_CAP_USD";
pub const BAIBOT_BILLING_MONTHLY_CAP_USD: &str = "BAIBOT_BILLING_MONTHLY_CAP_USD";
pub const BAIBOT_BILLING_MIN_TOPUP_USD: &str = "BAIBOT_BILLING_MIN_TOPUP_USD";
pub const BAIBOT_BILLING_MAX_TOPUP_USD: &str = "BAIBOT_BILLING_MAX_TOPUP_USD";
pub const BAIBOT_BILLING_ADMIN_MXIDS: &str = "BAIBOT_BILLING_ADMIN_MXIDS";
pub const BAIBOT_BILLING_DB_PATH: &str = "BAIBOT_BILLING_DB_PATH";

pub const BAIBOT_X402_SIDECAR_URL: &str = "BAIBOT_X402_SIDECAR_URL";
pub const BAIBOT_X402_INTERNAL_SECRET: &str = "BAIBOT_X402_INTERNAL_SECRET";
pub const BAIBOT_X402_INTERNAL_BIND: &str = "BAIBOT_X402_INTERNAL_BIND";
pub const BAIBOT_X402_INTERNAL_PORT: &str = "BAIBOT_X402_INTERNAL_PORT";
pub const BAIBOT_X402_ALLOW_NON_LOOPBACK_BIND: &str = "BAIBOT_X402_ALLOW_NON_LOOPBACK_BIND";
